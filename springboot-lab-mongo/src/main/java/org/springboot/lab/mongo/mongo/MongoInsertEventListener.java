package org.springboot.lab.mongo.mongo;
...
@Component
public class MongoInsertEventListener extends AbstractMongoEventListener<IncIdEntity<Number>> {
    ...
    @Override
    public void onBeforeConvert(BeforeConvertEvent<IncIdEntity<Number>> event) {
        IncIdEntity<Number> entity = event.getSource();
        // 判断 id 为空
     ...
     * @return ID 编号
     */
    private Number getNextId(IncIdEntity<Number> entity) {
        // 使用实体名的简单类名，作为 ID 编号
